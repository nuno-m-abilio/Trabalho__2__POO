...
public class Tela4MedAtualizaDados extends JFrame {
    
    public Tela4MedAtualizaDados(JFrame telaAnterior, EntityManagerFactory emf, Medico med) {
        ...
        botao1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                String novocpf = novo_cpf.getText();
                boolean fuma1; 
                boolean bebe1;
                boolean colesterol1;
                boolean diabetes1;
